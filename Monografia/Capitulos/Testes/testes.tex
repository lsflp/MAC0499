...
Há um gráfico, na Figura \ref{img:graficosrw}, que mostra a evolução do tempo de execução médio. Na tabela \ref{tab:srw} as médias e os intervalos de confiança podem ser vistos.
